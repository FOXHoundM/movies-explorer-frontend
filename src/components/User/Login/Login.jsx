				...
				<form noValidate className='login__form' onSubmit={handleSubmit}>
					<fieldset className='login__field'>
						<label className='login__label'>
							<p className='login__label_title login__label_title_email'>
								E-mail
							</p>
							<input
						...
						<label className='login__label'>
							<p className='login__label_title login__label_title_password'>
								Пароль
							</p>
							<input
					...
					<p className='login__subtitle'>
						...
						<Link to='/signup' className='login__subtitle_link'>
							Регистрация
						</Link>
					</p>
				</form>
